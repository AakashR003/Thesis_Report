...
representative result than single-frequency oscillation (because of inclusion of phase change). This discussion has been investigated in 
...
The frequency spectra for all superposition combinations are clean, showing only the static 
...
This large variation is the primary reason for the errors in the 
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{Chap_5/Figures/Simulation_Time.png}
