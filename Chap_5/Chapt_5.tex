...
This chapter describes a series of multi-frequency forced-motion CFD simulations performed to resolve the key questions 
...
Simulation parameters are first established on the basis of the signal analysis and nonlinearity investigations presented 
...
remain identical but the prescribed motion amplitudes are defined differently: in the first campaign the sum of the heave 
and pitch amplitudes within each superposition is kept below the linearity threshold, while in the second campaign the 
individual amplitudes are constrained below the same threshold. Finally, the insights obtained from both campaigns are 
synthesised into a practical framework for the selection of frequencies and amplitudes in multi-frequency simulations. 
