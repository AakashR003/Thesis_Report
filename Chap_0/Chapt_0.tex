...
By this approach, instead of applying a single forced motion, we can superimpose multiple forced 
...
investigated the multi-frequency approach to obtaining flutter derivatives via curve fitting with LES 
