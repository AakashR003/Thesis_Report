...
Flutter is an aeroelastic phenomenon that can cause instability failure of structures through interaction with wind. 
...
is forced motion simulation, where a 2D bridge deck is oscillated in virtual wind tunnel at a specific frequency, and the flutter derivatives are 
...
Fourier transform or curve fitting, the individual components can be obtained. In this way, the method can theoretically be \(N\) times as 
...
\begin{itemize}
    \item \textbf{Chapter 2: Aeroelastic Flutter} \\
