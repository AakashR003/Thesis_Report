...
First, examining the mathematical tool used for transformation. Secondly, investigation of validity of 
...
The multi-frequency method shows high reliability and time saving for higher reduced velocities and vice versa 
...
multi-frequency simulations, reducing computational cost by 60$\%$ compared to single-frequency methods. \\
