...
for lower reduced velocities. The proposed framework with frequency bin alignment and amplitude thresholds produces reliable 
...
multiple crossections to improve the confidence of this method. Since, this framework was entirely carried out with URANS approach with the $k$--$\omega$ SST 
