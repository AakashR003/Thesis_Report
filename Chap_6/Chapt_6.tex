...
In developing the framework for the multi-frequency simulation method, this thesis presents two key inferences. 
The first concerns the linearity characteristics of the Sarkic cross-section, derived from single-frequency simulations. 
...
the specific cross-section geometry.
...
in this thesis. This would ultimately increase the confidence on the multi-frequency method based on proposed framework.
