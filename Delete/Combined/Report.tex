...
investigated a multi-frequency method to obtaining flutter derivatives via curve fitting with LES 
...
\hspace{2cm}• Introduction to Multi-Frequency method   \\
...
\hspace{2cm}• Framework for efficient use of the multi-frequency method with FFT.  \\
\end{flushleft}
\newpage


%%%%%% Chap - 1 %%%%%%
\section*{Chapter 2:    Multi-Frequency method}
