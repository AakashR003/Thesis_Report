...
where:
\begin{align*}
C_L &= \text{coefficient of lift force}, \\
C_D &= \text{coefficient of drag force}, \\
\rho_{\mathrm{air}} &= \text{density of air}, \\
V_{\mathrm{rel}} &= \sqrt{V^2 + \dot{y}^2} = \text{relative velocity of wind to structure's velocity}, \\
\theta &= \tan^{-1}\left(\frac{\dot{y}}{V}\right) = \text{angle of attack}.
\end{align*}
